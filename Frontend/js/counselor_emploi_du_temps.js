        ...
        document.getElementById('patientProfileContent').innerHTML = `
            <div style="display: grid; gap: 15px;">
                ...
                <div style="background: #44AA99; color: white; padding: 15px; border-radius: 8px; text-align: center;">
                    <button onclick="closePatientModal(); window.location.href='counselor_mes_patients.html'" style="background: white; color: #44AA99; border: none; padding: 10px 20px; border-radius: 8px; cursor: pointer; font-weight: bold; width: 100%;">
                        Voir fiche complète
                    </button>
                </div>
            </div>
